...
import { uploadsAPI, BASE_SERVER_URL } from "../../api/api";
          ...
          <tbody>
            {uploads.map(u => {
              ...
              const fileUrl = isAdvertiser
                ? `${BASE_SERVER_URL}/uploads/advertiser-media/${u.filename}`
                : `${BASE_SERVER_URL}/uploads/${u.filename}`;
                      ...
                      {u.filename && (
                        <>
                          <img 
                            ...
                            onError={(e) => { e.target.src = "https://placehold.co/40x40?text=Error"; }}
                          />
                          <a href={fileUrl} target="_blank" rel="noreferrer" className="text-blue-400 underline truncate max-w-[150px]">
                            {u.filename}
                          </a>
                        </>
                      )}
